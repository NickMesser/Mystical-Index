...
public class ServerParticleUtil {
    ...
    public static void spawnParticle(Direction.Axis axis, ServerWorld world, BlockPos pos, double variance, ParticleEffect effect, UniformIntProvider range) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            world.spawnParticles(effect, d, e, f, 0, g, h, k, 0);
        }
    }

    public static void spawnParticle(ServerWorld world, BlockPos pos, Direction direction, ParticleEffect effect) {
        Vec3d vec3d = Vec3d.ofCenter(pos);
        ...
        world.spawnParticles(effect, d, e, f, 0, g, h, l, 0);
    }
}