...
public class MagicalIndexScreen extends HandledScreen<MagicalIndexScreenHandler> {
    private static final Identifier TEXTURE = new Identifier("mystical_index:textures/gui/library_screen.png");

    public MagicalIndexScreen(MagicalIndexScreenHandler handler, PlayerInventory inventory, Text title) {
