...
public class EntityPaperRecicpe extends ShapedRecipe {
    public EntityPaperRecicpe(Identifier id, String group, CraftingRecipeCategory category, int width, int height, DefaultedList<Ingredient> input, ItemStack output) {
        super(id, group, category, width, height, input, output);
    }

    @Override
    public ItemStack craft(RecipeInputInventory recipeInputInventory, DynamicRegistryManager dynamicRegistryManager) {
        var firstItem = recipeInputInventory.getInputStacks().get(0);
    ...
    public static class Serializer implements RecipeSerializer<EntityPaperRecicpe>
    {
        public Serializer() {
        }

        public EntityPaperRecicpe read(Identifier identifier, JsonObject jsonObject) {
            ...
            return new EntityPaperRecicpe(identifier, string, craftingRecipeCategory, i, j, defaultedList, itemStack);
        }

        public EntityPaperRecicpe read(Identifier identifier, PacketByteBuf packetByteBuf) {
            ...
            return new EntityPaperRecicpe(identifier, string, craftingRecipeCategory, i, j, defaultedList, k);
        }

        public void write(PacketByteBuf packetByteBuf, EntityPaperRecicpe shapedRecipe) {
